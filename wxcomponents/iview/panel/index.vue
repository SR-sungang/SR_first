<template>
<uni-shadow-root class="iview-panel-index"><view class="i-class i-panel">
...
global['__wxRoute'] = 'iview/panel/index'
Component({
...
export default global['__wxComponents']['iview/panel/index']
</script>
