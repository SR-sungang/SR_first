<template>
<uni-shadow-root class="iview-progress-index"><view :class="'i-class i-progress i-progress-'+(status)+' '+(!hideInfo ? 'i-progress-show-info' : '')">
...
global['__wxRoute'] = 'iview/progress/index'
Component({
...
export default global['__wxComponents']['iview/progress/index']
</script>
