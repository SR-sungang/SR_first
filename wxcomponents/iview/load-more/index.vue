<template>
<uni-shadow-root class="iview-load-more-index"><view :class="'i-class i-load-more '+(loading ? '' : 'i-load-more-line')">
...
global['__wxRoute'] = 'iview/load-more/index'
Component({
...
export default global['__wxComponents']['iview/load-more/index']
</script>
