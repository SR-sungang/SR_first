<template>
<uni-shadow-root class="iview-count-down-index"><text class="countdown-class">
  {{time}}
</text></uni-shadow-root>
</template>

<script>

global['__wxRoute'] = 'iview/count-down/index'
Component({
    properties: {
        target: Number,
        showDay: Boolean,
...
export default global['__wxComponents']['iview/count-down/index']
</script>
