<template>
<uni-shadow-root class="iview-input-index"><view :class="'i-class i-cell i-input '+(error ? 'i-input-error' : '')+' '+(mode === 'wrapped' ? 'i-input-wrapped' : '')">
...
global['__wxRoute'] = 'iview/input/index'
Component({
...
export default global['__wxComponents']['iview/input/index']
</script>
