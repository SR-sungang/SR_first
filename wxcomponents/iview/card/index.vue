<template>
<uni-shadow-root class="iview-card-index"><view :class="'i-class i-card '+(full ? 'i-card-full' : '')">
...
global['__wxRoute'] = 'iview/card/index'
Component({
...
export default global['__wxComponents']['iview/card/index']
</script>
